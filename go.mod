...
require (
	...
	github.com/polymerdao/polymerase/chain v0.0.0-00010101000000-000000000000
	github.com/polymerdao/prover-contracts v0.0.16
	github.com/polymerdao/telemetry v0.2.6
	github.com/polymerdao/utils v0.0.0-20250116174148-e0b913bb3b00
...
replace (
	github.com/cometbft/cometbft => github.com/polymerdao/cometbft v0.37.3-0.20241001155130-7e30782771a6
	// use latest golang.org/x/exp/slices api
	github.com/cosmos/cosmos-sdk => github.com/polymerdao/cosmos-sdk v0.47.5-polymer-op-v1.9.1
	// use latest golang.org/x/exp/slices api
	github.com/cosmos/gogoproto => github.com/polymerdao/gogoproto v0.0.0-20230905135849-dbeac9fa0743
	github.com/cosmos/ibc-go/v7 => github.com/polymerdao/ibcx-go/v7 v7.0.0-20240501093146-bdbdb199f76d
	// we should always keep optimism fork and op-geth fork in sync
	github.com/ethereum-optimism/optimism v1.9.1 => github.com/polymerdao/optimism-dev v1.9.1-polymer-dev
	// we should always keep optimism fork and op-geth fork in sync
	...
	github.com/miguelmota/go-ethereum-hdwallet => github.com/polymerdao/go-ethereum-hdwallet v0.0.0-20231119022523-4132e3224df3

	// Polymerase replaces
	github.com/polymerdao/polymerase/chain => github.com/polymerdao/polymerase/chain v0.0.0-20241230175848-804157981a57
